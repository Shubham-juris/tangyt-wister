...
//     <div className="bg-red-600 text-white flex flex-col sm:flex-row items-center justify-center p-6 md:p-10">
//   {/* Image Section */}
  ...
  return (
    <div>
      ...
      >
        {/* Main Heading */}
        <motion.h1
          className="text-3xl mt-15 md:text-4xl lg:text-6xl font-bold text-center mb-6"
      ...
      <motion.div
        className="bg-red-600 text-white flex flex-col sm:flex-row items-center justify-center p-6 md:p-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
        ...
        <div className="w-full sm:w-1/2 p-6 md:p-9 flex flex-col justify-center text-center sm:text-left">
          ...
          <motion.p
            ...
            transition={{ duration: 1 }}
          >
            At Tangy Twisters, we're not just your ordinary restaurant – we're a culinary destination that caters to all tastes and cravings. Specializing in a diverse array of offerings, we proudly serve up a mouthwatering menu featuring pizzas, sides, snacks, and even Indian cuisine.
          </motion.p>
        </div>
      </motion.div>
      ...
      <motion.div
        className="text-4xl sm:text-center text-red-600 mt-16 mx-10 my-6"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <img
                src="https://images.pexels.com/photos/162744/tomatoes-tomato-quiche-red-yellow-162744.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Specials"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
            ...
            >
              <img
                src="https://images.pexels.com/photos/2295285/pexels-photo-2295285.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Specials"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
            ...
            >
              <img
                src="https://images.pexels.com/photos/8477413/pexels-photo-8477413.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Specials"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
            ...
            >
              <img
                src="https://images.pexels.com/photos/616836/pexels-photo-616836.jpeg?auto=compress&cs=tinysrgb&w=600"
                alt="Specials"
                className="w-full h-48 object-cover"
              />
              <div className="p-6">
      ...
      {/* Reservation Section */}
      <motion.div
        className="relative z-7 text-center text-xl text-black py-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
        <motion.h1
          className="text-xl md:text-5xl mb-4"
          initial={{ y: -50, opacity: 0 }}
          animate={{ y: 0, opacity: 1 }}
          transition={{ duration: 1 }}
        >
        ...
        <Link to="/reservation">
          <motion.button
            className="bg-red-600 cursor-pointer hover:bg-red-700 text-white py-2 px-5 rounded-full"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
          >
            Reserve Now

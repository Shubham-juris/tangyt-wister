...
const Reservation = () => {
  return (
    <div>
      ...
      <motion.div
        className="relative bg-gray-800 mt-15 py-13 overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* Reservation Quote Section */}
      <motion.div
        className="bg-white mt-15 mb-10 font-sans py-10"
        initial={{ opacity: 0 }}
      ...
      >
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-2xl font-semibold text-gray-800 mb-4">TABLE RESERVATION</h1>
          <p className="text-gray-600 mb-5">
            Don't miss out on the incredible dining experience at Tangy Twisters. Reserve your table now!
          </p>
          <motion.div
            className="bg-gray-200 rounded-md py-6 px-8 text-gray-700"
      ...
      >
        <div className="max-w-2xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
          <motion.h1
            className="text-3xl text-red-600 text-center mb-4"
          ...
          >
            {['name', 'phone', 'people', 'date', 'email'].map((field, index) => (
              <motion.div
                key={field}
                variants={{
              ...
              >
                <label htmlFor={field} className="block text-gray-700 text-sm font-bold mb-2 capitalize">
                  {field === 'people' ? 'People' : field.charAt(0).toUpperCase() + field.slice(1)}
                </label>
                <input
                  type={field === 'email' ? 'email' : field === 'date' ? 'date' : field === 'people' ? 'number' : 'text'}
                  id={field}
                  className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                />
              </motion.div>

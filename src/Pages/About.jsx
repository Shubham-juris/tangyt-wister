        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              <div className="relative w-55 h-55 mx-auto rounded-full overflow-hidden shadow-md">
                <img
                  src="https://images.pexels.com/photos/1435903/pexels-photo-1435903.jpeg"
                  alt="Our Food"
                  className="object-cover w-full h-full"
                />
              </div>
            ...
            >
              <div className="relative w-55 h-55 mx-auto rounded-full overflow-hidden shadow-md">
                <img
                  src="https://images.pexels.com/photos/3762069/pexels-photo-3762069.jpeg"
                  alt="Our Menu"
                  className="object-cover w-full h-full"
                />
              </div>
